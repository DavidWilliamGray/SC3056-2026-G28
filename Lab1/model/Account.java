...
public class Account {
	...
	/*public String toString() {
		...
		return account_number + ", " + username_of_account_holder + ", " + account_type + ", " + sdf.format(account_opening_date);
	}*/
	...
	public String toString() {
		...
		return String.format("%-10s| %-30s| %-10s| %-15s",
				account_number, username_of_account_holder, account_type, sdf.format(account_opening_date));
	}
}
